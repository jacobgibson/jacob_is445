Public Class NumberDivision1
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Submit.Click
        Dim num As Integer = Convert.ToInt32(UserInputTextBox.Text)
        If num >= 2 AndAlso num <= 10 Then
            ...
            Output.Text = "Your input number is " & num
            Output.Text &= "<br />The number of times to divide the number " & num & " by 2 to get a value less than one millionth is " & counter
        End If
    End Sub
